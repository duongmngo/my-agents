...
from app.api.v1 import auth, examples, workspaces, folders, notes, embedding
...
app.include_router(embedding.router, prefix=f"{settings.api_v1_prefix}/embedding", tags=["embedding"])
